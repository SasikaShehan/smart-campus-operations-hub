...
import com.sliit.paf.smartCampusHub.dto.FacilityDTO;
import com.sliit.paf.smartCampusHub.model.Facility;
import com.sliit.paf.smartCampusHub.service.FacilityService;
...
public class FacilityController {
    ...
    public ResponseEntity<?> createFacility(@RequestBody @jakarta.validation.Valid FacilityDTO dto) {
        try {
    ...
    @PutMapping("/{id}")
    @PreAuthorize("hasRole('ADMIN')")
    public ResponseEntity<?> updateFacility(@PathVariable Long id, @RequestBody @jakarta.validation.Valid FacilityDTO dto) {
        try {
