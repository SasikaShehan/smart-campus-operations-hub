...
import com.sliit.paf.smartCampusHub.service.BookingService;
...
public class BookingController {
    ...
    @GetMapping("/{id}")
    @PreAuthorize("hasAnyRole('STUDENT', 'LECTURER', 'TECHNICIAN', 'ADMIN', 'MANAGER')")
    ...
    @PostMapping
    @PreAuthorize("hasAnyRole('STUDENT', 'LECTURER', 'TECHNICIAN', 'ADMIN', 'MANAGER')")
    public ResponseEntity<?> createBooking(@RequestBody @jakarta.validation.Valid BookingDTO dto, Authentication auth) {
        try {
    ...
    public ResponseEntity<?> updateBooking(@PathVariable Long id, 
                                           @RequestBody @jakarta.validation.Valid BookingDTO dto,
                                           Authentication auth) {
        try {
            User user = getUserFromAuth(auth);
