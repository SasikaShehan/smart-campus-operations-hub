  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
      <div>
        ...
        <Input id="name" {...register("name")} placeholder="e.g. Main Hall A" />
      ...
      <div>
        ...
        <Input id="location" {...register("location")} placeholder="e.g. Block C, Level 2" />
      ...
      <div>
        ...
        />
        {errors.availabilitySchedule && <p className="text-xs text-destructive mt-1">{errors.availabilitySchedule.message}</p>}
      </div>
